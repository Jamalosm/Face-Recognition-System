...
class App:
    ...
    def login(self):
        label = test(image=self.most_recent_capture_arr, model_dir='./anti_spoof_models', device_id=0)
    ...
    def accept_register_new_user(self):
        ...
        if len(face_encodings) == 0:
            util.msg_box('No face detected', 'Please make sure your face is clearly visible.')
            return
